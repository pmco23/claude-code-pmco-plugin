...
Test command: `bash hooks/test_gate.sh`
Lint command: none
Build command: none
...
- `hooks/test_gate.sh` — gate test suite (run before every commit)
...
- Run `bash hooks/test_gate.sh` after any change to hooks or gate logic. All tests must pass.
